...
public class PhotoInfo implements Parcelable {
    ...
    public PhotoInfo(String name, String path, long time, int width, int height, long size, long duration, String type) {
        this.name = name;
        this.path = path;
        this.time = time;
        this.width = width;
    ...
    public PhotoInfo(String name, String path, String type) {
        this.name = name;
        this.path = path;
        this.type = type;
    }
